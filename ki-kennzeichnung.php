...
define( 'AIKZ_URL', plugin_dir_url( __FILE__ ) );
define( 'AIKZ_PATH', plugin_dir_path( __FILE__ ) );

require_once AIKZ_PATH . 'includes/class-aikz-marker.php';
AIKZ_Marker::instance();
